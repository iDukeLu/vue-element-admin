...
import exampleRouter from './modules/exampleRouter'
import tabRouter from '@/router/modules/tabRouter'
import errorLogRouter from '@/router/modules/errorLogRouter'
import excelRouter from '@/router/modules/excelRouter'
import zipRouter from '@/router/modules/zipRouter'
import pdfRouter from '@/router/modules/pdfRouter'
import themeRouter from '@/router/modules/themeRouter'
import clipboardRouter from '@/router/modules/clipboardRouter'
